...
workout_1 = WorkoutA(squat_reps="5,4,5,5,5", bench_reps="5,5,5,5,3",
  ...
  row_sets=25,  press_sets=25,  deadlift_sets=5, workout_a_b='A', workout_complete=1, user_id=1)

user = User(name='mike', password="aaaaaa", email='test@email.com', role='user')
db.session.add(user)
